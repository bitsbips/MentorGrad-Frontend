...
import { HeaderCart, HeaderCartContent, HeaderCartContentPostion, HeaderCartTopBack, HeaderCartimg, HeaderName, HeaderOccupation, IconBack } from "../pages/Mentor/MentorStyles";
