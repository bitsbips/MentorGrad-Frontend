...
const useStyles = makeStyles({
    ...
    MuiAccordionroot: {
        ...
        "&:first-child": {
            "&.MuiAccordion-root:before": {
                content: "none" // Remove border for the first accordion
            }
        }
    },
    MuiAccordionSummaryExpanded: {
        borderTop: "1px solid #7476D1", // Replace "yourBorderColor" with the desired border color
        "&.Mui-expanded": {
            borderTop: "1px solid #7476D1" // Replace "yourBorderColor" with the desired border color
        }
    }
...
export default function SimpleAccordion() {
    ...
    return (
        <BottomPosHome>
            <RowDirection style={{ marginTop: 30 }}>

                <ColDirection>

                    <BoldHeading>General  <BoldHeading style={{ color: '#7476D1' }}>FAQs </BoldHeading></BoldHeading>
                    {isMobile ?
                        <>
