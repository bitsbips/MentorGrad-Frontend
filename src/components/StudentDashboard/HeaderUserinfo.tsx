...
import { ContainerDashboard, HeaderName, HeaderPassion, PositionHeader, PositionImage, PositionTextCol, RightBorderDashboard, RightContainerDash } from "./StudentDashboardStyles";
...
const HeaderUserinfo = () => {
    ...
    return (
        <ContainerDashboard>
            ...
            <div style={{ marginTop: '2%',marginLeft:isMobile ? '' : '-5%',marginBottom:isMobile?"5%":"4%" }}>
