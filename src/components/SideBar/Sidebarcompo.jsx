...
const Sidebarcompo = ({ classes }) => {
  ...
  return (
    <div>
      ...
      >
        <List>
          <ListItem onClick={() => handleListItemClick('Home')} className={selectedItem === 'Home' ? 'active' : ''}>
            <HomeIcon className={selectedItem === 'Home' ? 'active-icon' : ''} />
            <ListItemText primary="Home" />
          </ListItem>
          <ListItem onClick={() => handleListItemClick('About')} className={selectedItem === 'About' ? 'active' : ''}>
            <InfoIcon className={selectedItem === 'About' ? 'active-icon' : ''} />
            <ListItemText primary="About" />
          </ListItem>
          <ListItem onClick={() => handleListItemClick('Services')} className={selectedItem === 'Services' ? 'active' : ''}>
            <AssignmentIcon className={selectedItem === 'Services' ? 'active-icon' : ''} />
