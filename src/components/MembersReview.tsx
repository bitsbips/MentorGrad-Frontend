...
import { BottomPosHome, ColDirection, Column, MembersBack, MembersBack1, MembersImage, MembersName, MembersPassion, MembersRe, MembersRe1, MembersRe1Width, MembersText, MembersText1, MobileMembers, Row, RowDirection, RowDirectionBetween, RowDirectionMembers, RowDirectionMembers1, RowWorks } from "../pages/Home/HomeStyles";
            ...
            {isMobile ?
                <BottomPosHome>
                    <RowDirectionBetween>
                        <div style={{ width: '60%' }}>
                            <ColDirection>
                                <MembersText>What Do <br /> Members Say <br /> About Us?</MembersText>
                                
                                    <Row>
                                    
                                        <FiArrowLeft color="#7476D1" style={{ cursor: 'pointer' }} size={23} onClick={handlePreviousClick}/>
                                    
                                        <FiArrowRight color="#7476D1" style={{ cursor: 'pointer', marginLeft: '5%' }} size={23} onClick={handleNextClick}/>
                                    </Row>
