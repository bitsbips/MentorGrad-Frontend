    ...
    <Container>
      ...
      <div style={{ marginTop: '2%' }}>
        <BottomPosHome>
          ...
          <MentorSubHeading>
            Mentoring is highly valued by managers, executives, and leaders as a
            highly effective use of time that helps cultivate essential
            leadership skills.
          </MentorSubHeading>
        </BottomPosHome>
      </div>
      ...
      <div style={{ marginTop: '0.5%' }}>
        <BottomPosHome>
          ...
          <MentorSubHeading>
            Partnering with Us means you won't have to take care of anything
        ...
        <BottomNewsMentor>
          <ColDirection>
            <NewsHeadMentor>
              Become Part of the
              <br />
              Leading Mentoring Community
            </NewsHeadMentor>
            <MentorSubHeadingbtm>
              Thousands of mentees and mentors can't be wrong – with a 97%
              satisfaction rate,
              <br /> We are one of the highest quality mentoring communities out
              there.
            </MentorSubHeadingbtm>
            <ButtonComp
              fontSize={'14px'}
