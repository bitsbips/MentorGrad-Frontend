...
import { CenterContent, Container, ErrorText, ForgetPass, HeadingTop, Position, PositionCol } from '../AuthStyles'
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <Position>
                            <ForgetPass onClick={() => navigate('/forgetEmail')}>Forget Password?</ForgetPass>
                                ...
                                <Button fontSize={'14px'} load={load} style={{ padding: '2%' }} onSubmit={handleSubmit} title='Sign in' onClick={() => handleSubmit()} width={'40%'} />
